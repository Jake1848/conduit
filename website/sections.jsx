...
function StatStrip() {
  const items = [
    { lbl: 'Networks live',     to: 3,   decimals: 0, prefix: '', suffix: '',  delta: 'mainnet · testnet · regtest', seed: 12 },
    { lbl: 'Platform fee',      to: 0.5, decimals: 1, prefix: '', suffix: '%', delta: 'default · you keep it',       seed: 34 },
    { lbl: 'MCP tools',         to: 8,   decimals: 0, prefix: '', suffix: '',  delta: 'pay · receive · policy …',    seed: 56 },
    { lbl: 'Open-source SDKs',  to: 2,   decimals: 0, prefix: '', suffix: '',  delta: 'Python · TypeScript',         seed: 78 },
  ];
  return (
    <React.Fragment>
      ...
      <div className="strip-note" data-reveal>Self-hosted and non-custodial — every node is run by its operator on their own infrastructure, and Conduit never holds funds. Mainnet-validated, early.</div>
    </React.Fragment>
  );
}
